...
@section('content')
    <div>
        ...
        <div class="swiper swiper1">
            ...
            <div class="swiper-wrapper">
                <!-- Slides -->
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl1.JPG)">
                        <div class="container">
                            <div class="row">
                                <div class="col-text col-md-6"></div>
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b pu-text aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Let's Start With innovative Design
                                        </h2>
                ...
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl2.JPG)">
                        <div class="container">
                            <div class="row">
                                <div class="col-text col-md-6"></div>
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b o-text aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Website Design And Development
                                        </h2>
                ...
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl3.JPG)">
                        <div class="container">
                            <div class="row">
                                <div class="col-text col-md-6"></div>
                                ...
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b white-1 aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Social Media Management </h2>
                ...
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl4.JPG)">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b o-text aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Graphic Designing </h2>
                ...
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl5.JPG)">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b b-text aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Mobile Application Development
                                        </h2>
                ...
                <div class="swiper-slide js-fullheight">
                    <div class="  slide-img  " style="background-image: url(/images/sl6.JPG)">
                        <div class="container">
                            <div class="row">
                                <div class="col-text col-md-6"></div>
                                ...
                                <div class="col-text col-md-6">
                                    <div class="banner-text-animate">
                                        <h2 class="main_title-b white-1 aos-init aos-animate" data-aos="fade-up"
                                            data-aos-delay="200" data-aos-duration="500">Content Translation </h2>
    ...
    <section class="sec-sec">
        <div class=" container">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 section_2" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
    ...
    <div class="container-fluid orange">
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-6 col-lg-6 " data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                    ...
                    <a href="/contact"> <button class="custom-btn my-4 btn-5"><span>Contact Us</span></button></a>
    ...
    <section class="my-10">
        ...
        <div class="container">
            <div class="row justify-center">
                <div class="col-lg-12   mb-10 text-center" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="500">
                    <h2 class="main_title"> Our Services</h2>
                </div>
                <div class="service col-md-4" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
    ...
    <section>
        <div class="container plans">
            <div class="row">
                <div class="col-lg-12 mt-10 text-center" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="500">
                    ...
                    <ul class="nav nav-pills mb-3 mt-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-profile" aria-selected="false">SOCIAL MEDIA MANGMENT</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-marketing-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-marketing" type="button" role="tab"
                                aria-controls="pills-marketing" aria-selected="false"> GRAPHIC DESIGN</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="row my-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                        ...
                        <div class="col-lg-4" style="z-index: 1">
                            ...
                            <div class="pricing__table  plan2">
                                ...
                                <ul class="features__list">
                                    ...
                                    <li>
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                        Social Media 1 Theme
                                        Design
                                    </li>
                                    <li>
                                        <i class="fa fa-check" aria-hidden="true"></i>
                                        Website Design 1-3 Pages
                                    </li>
                                </ul>
                                <a href="/contact" class="cta_btn">Request</a>
                            </div>
    ...
    <section>
        <div class="row">
            <div class="row">
                <div class="col-lg-12 mt-10 text-center" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="500">
                    <h2 class="main_title"> Other Services</h2>
                </div>
            </div>
            <div class="col-lg-12">
    ...
    <section class="port-sec">
        <div id="gallery" class="container">
            <div class="popup-gallery">
                <div class="row">
                    <div class="col-md-4 col-lg-4 my-4" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/logo0.JPG" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/logo0.JPG"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4  my-4" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/web4.png" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/web4.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 my-4 " data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/web1.png" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/web1.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 my-4 " data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/logo6.JPG" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/logo6.JPG"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 my-4 " data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/logo8.JPG" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/logo8.JPG"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 my-4" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                        <div class="resources-item">
                            <div class="resources-category-image">
                                <a href="/images/portfoilo/web5.png" title=""><img class="img-responsive"
                                        alt="" src="/images/portfoilo/web5.png"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 text-center">
                <button class="custom-btn my-4 btn-5"><a href="/portfolio"><span>All
